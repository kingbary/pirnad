        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              ...
              className="flex-1 md:flex-none bg-emerald-600 hover:bg-emerald-700 hover:scale-105 transition-all duration-300 shadow-lg"
            >
            ...
            <Button
              ...
              className="flex-1 md:flex-none bg-blue-600 hover:bg-blue-700 text-white hover:scale-105 transition-all duration-300 shadow-lg"
            >
