...
export async function POST(request: NextRequest) {
  try {
    ...
    // Email content for the business (you receive this)
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="margin: 20px 0;">
            ...
            ${
              message
                ? `<p style="margin: 10px 0;"><strong>Message:</strong><br/>${message.replace(
                    /\n/g,
                    "<br/>"
                  )}</p>`
                : ""
    ...
    // Email content for the customer (confirmation email)
